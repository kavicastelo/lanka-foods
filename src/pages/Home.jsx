        ...
        <div>
            ...
            <section className="relative overflow-hidden">
                <div className="absolute inset-0">
                    <Image src={IMG.hero} alt="Sri Lankan food" priority originWidth={1600} originHeight={1067} fittingType="fill" className="h-full w-full" />
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-32 lg:py-40">
                    <div className="max-w-2xl">
                        ...
                        <p className="mt-4 sm:mt-5 max-w-xl text-base sm:text-lg text-white/95 font-500">
                        ...
                        <form onSubmit={explore} className="mt-6 sm:mt-8 rounded-2xl bg-white p-2 shadow-2xl sm:flex sm:items-center">
                            <div className="flex items-center gap-2 border-b border-border px-3 py-2 sm:border-b-0 sm:border-r">
                                ...
                                <select value={city} onChange={(e) => setCity(e.target.value)} aria-label="Select City" className="bg-transparent text-sm font-600 outline-none max-w-[120px]">
                                    {cities.map((c) => <option key={c} value={c}>{c}</option>)}
                                </select>
                            </div>
                            <div className="flex flex-1 items-center gap-2 px-3 py-2">
                                <Search className="h-5 w-5 text-muted-foreground" />
                                <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search restaurants or dishes" aria-label="Search restaurants or dishes" className="w-full bg-transparent text-sm outline-none" />
                            </div>
                            <button type="submit" aria-label="Explore Food" className="flex w-full items-center justify-center gap-2 rounded-xl bg-spice-gradient px-6 py-3 text-sm font-700 text-white shadow-warm transition hover:opacity-95 sm:w-auto">
                        ...
                        <div className="mt-6 flex flex-wrap gap-3">
                            ...
                            <Link to="/partner" className="rounded-full bg-white px-5 py-2.5 text-sm font-700 text-emerald-950 transition hover:bg-white/90">
            ...
            <section className="mx-auto max-w-7xl px-4 sm:px-6 pb-16 sm:pb-20">
                ...
                <div className="relative overflow-hidden rounded-3xl bg-spice-gradient px-8 py-14 text-white sm:px-14">
                    ...
                    <div className="relative max-w-xl">
                        ...
                        <Link to="/partner" className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-700 text-emerald-950 transition hover:bg-white/90">
