...
import type { DeleteMediaInput, RequestUploadUrlInput } from './media.schemas.js';
...
export class MediaService {
  ...
  static async deleteMedia(
    ...
    if (userRole !== 'SUPER_ADMIN') {
      ...
      } else if (!input.objectKey.startsWith(`applications/${requestingUserId}/`) && !input.objectKey.startsWith(`uploads/${requestingUserId}/`)) {
